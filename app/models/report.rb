class Report < ActiveRecord::Base
  ...
  def to_csv
    CSV.generate do |csv|
      csv << ["Video Title", "Source/Medium", "YouTube Id", "Channel Subscribers", "Views", "Cost", "GA New Users", "GA Transactions", "GA Revenue", "GA Goal 4 Completions", "ROI", "Cost/Sub ($)", "Rev/Sub ($)", "Cost/View ($)", "Rev/View ($)", "Cost/Lead", "Cost/Action"]
